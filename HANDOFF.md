...
## Current Status (v0.3.97)
1. **Crew Schedule Grid Visual Distinction**: Added prominent 2px row dividers, alternating zebra striping, personnel-type colored accent borders, and dynamic row hover styling so it is effortless to trace flights and duties to specific individuals.
