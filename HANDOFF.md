...
1. **Unified Badges & Soft Shading Grid**: Standardized PILOT, CREW, and PAX badge aesthetics to a uniform soft-fill + outline pill design and replaced prominent line breaks with soft, alternating row shading (`#ffffff` / `#f8fafc`).
