...
1. **Calendar View Personnel Status Modal**: Clicking on personnel status bubbles in the monthly Calendar View opens the full Daily Itinerary status editing popup identically to the Crew Schedules grid.
